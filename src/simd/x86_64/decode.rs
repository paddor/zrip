...
use crate::decode::sequences::{SequenceDecodeTables, compute_offset};
use crate::error::DecompressError;
use crate::fse::FseSeqDecodeEntry;
...
unsafe fn copy_match_from_history(
    ...
    if remaining > 0 {
        unsafe {
            super::avx2::copy_match_avx2(op.add(from_history), offset, remaining);
        }
    }
}
